        ...
        <div class="box-container">
            <div class="info-project">
                <div class="box-child info-img">
                    <picture>
                        <source srcset="./images/content/project/centro-calma/lap.webp" type="image/webp">
                        <source srcset="./images/content/project/centro-calma/lap.png" type="image/png">
                        <img src="./images/content/project/centro-calma/lap.webp" alt="jytech" loading="lazy">
                    </picture>
                </div>
                <div class="box-child info-text">
                    <p class="title">Desarrollo Web</p>
                    <img src="./images/content/project/line.svg" alt="line" loading="lazy">
                    <a href="https://www.centroencalma.com">
                        <img src="./images/content/portafolio/icon-url.svg" alt="Icon url">
                        www.centroencalma.com
                    </a>
                    <h2>Centro en Calma</h2>
            ...
            <div class="box-devices">
                <picture>
                    <source srcset="./images/content/project/centro-calma/mov.webp" type="image/webp">
                    <source srcset="./images/content/project/centro-calma/mov.png" type="image/png">
                    <img class="mov" src="./images/content/project/centro-calma/mov.webp" alt="jytech" loading="lazy">
                </picture>
                <picture>
                    <source srcset="./images/content/project/centro-calma/device.webp" type="image/webp">
                    <source srcset="./images/content/project/centro-calma/device.png" type="image/png">
                    <img class="device" src="./images/content/project/centro-calma/device.webp" alt="jytech" loading="lazy">
                </picture>
            </div>
        </div>
    </section>
