...
$page_class="Desarrolo de tiendas online";
$city=" en Puebla";
...
$page_desc="La demanda de oportunidades de compra flexibles, simples y convenientes ha ido creciendo de manera acelerada por lo que la demanda de migrar un sistema tradicional de ventas a ventas online amplia el mercado y pone a la vanguardia a las empresas que integran esta estarategia. En la agencia, a lo largo de más de 8 años hemos llevado a cabo proyectos de Ecommerce brindando innovadoras soluciones de implementación a cada empresa.";
$keywords_city=array(
	'paginas web',
...
<section class="services-info">
	<h1 class="text-center">Desarrollo de tiendas online</h1>
	<p class="services-desc">La demanda de oportunidades de compra flexibles, simples y convenientes ha ido creciendo de manera acelerada por lo que la demanda de migrar un sistema tradicional de ventas a ventas online amplia el mercado y pone a la vanguardia a las empresas que integran esta estarategia. En la agencia, a lo largo de más de 8 años hemos llevado a cabo proyectos de Ecommerce brindando innovadoras soluciones de implementación a cada empresa.</p>
	<p class="services-desc">Plataformas de eCommerce</p>
	<h3 class="services-desc">(Evaluaremos tu capacidad logística y objetivos comerciales para recomendarte la plataforma más adecuada)</h3>
</section>
