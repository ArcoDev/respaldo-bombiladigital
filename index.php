...
<div id="wrapper">
	<main>
				...
				<div class="canvas-wrap">
					<div class="container">
						<div class="canvas-content">
							...
							<p class="animaDesc">Estás a un paso de tener la herramienta de presencia online y de ventas más importante.</p>
							<a href="#contacto" class="go-to btn-flat secondary">Contáctanos</a>
						</div>
						<div class="canvas-img">
							<picture>
								<source srcset="/images/content/main-slider/bombilla-digital-01.webp" type="image/webp">
								<source srcset="/images/content/main-slider/bombilla-digital-01.png" type="image/png">
								<img src="/images/content/main-slider/bombilla-digital-01.webp" alt="<?=$brand_name?>">
							</picture>
						</div>
					</div>
		...
		<section class="home__services">
			...
			<div class="container">
				<div class="<?=$animation_type?>" data-200="transform:translateY(50px);opacity:0" data-700="transform:translateY(0px);opacity:1">
						...
						<div class="col-lg-6 img">
							<div class="service__img <?=$animation_type?>">
								<picture>
									...
									<img src="/images/content/services/web.webp" alt="Diseño y Desarrollo Web | <?=$brand_name?>">
								</picture>
							</div>
						</div>
						<div class="col-lg-5 offset-lg-1">
							<div class="service__text--wrapper <?=$animation_type?>" data-text="right">
								<svg class="service__icon"><use xlink:href="#svg-icon-web"></use></svg>
								<h2 class="service__title">Diseño y<br>Desarrollo Web</h2>
								<div class="service__text">
									<p>Se trata de hacer un sitio Web con un diseño atractivo, que sea entendible para Google y a la vez amigable e interesante para el usuario.</p>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row-flex vc">
						<div class="col-lg-5 service__text-right">
							<div class="service__text--wrapper <?=$animation_type?>" data-text="left">
								<svg class="service__icon"><use xlink:href="#svg-icon-seo"></use></svg>
								<h2 class="service__title">Posicionamiento<br>en Buscadores</h2>
								<div class="service__text">
									<p>Nos especializamos en la administración de Campañas de posicionamiento con Google Ads, siendo esta estrategia una de las más eficaces en publicidad digital para conseguir nuevos clientes y prospectos.</p>
								</div>
							</div>
						</div>
						<div class="col-lg-6 offset-lg-1 img">
							<div class="service__img <?=$animation_type?>">
								<picture>
									...
									<img src="/images/content/services/seo.webp" alt="Posicionamiento en Buscadores | <?=$brand_name?>">
								</picture>
							</div>
						</div>
					</div>
						...
						<div class="col-lg-5 img">
							<div class="service__img <?=$animation_type?>">
								<picture>
									...
									<img src="/images/content/services/hosting.webp" alt="Dominio y Hospedaje Web | <?=$brand_name?>">
								</picture>
							</div>
						</div>
						<div class="col-lg-6 offset-lg-1">
							<div class="service__text--wrapper <?=$animation_type?>" data-text="right">
								<svg class="service__icon"><use xlink:href="#svg-icon-hosting"></use></svg>
								<h2 class="service__title">Dominio y <br>Hospedaje Web</h2>
								<div class="service__text">
									<p>Nos aseguramos de que tu sitio web siempre funcione adecuadamente, mantente online.</p>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="service--wrapper">
					<div class="row-flex vc">
						<div class="col-lg-7 service__text-right">
							<div class="service__text--wrapper <?=$animation_type?>" data-text="left">
								<svg class="service__icon"><use xlink:href="#svg-icon-consultoria"></use></svg>
								<h2 class="service__title">Consultoría</h2>
								<div class="service__text">
									<p>Partimos de un diagnóstico para diseñar la estrategia más adecuada y necesaria para tu negocio o empresa, implementamos acciones que agregan valor.</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 offset-lg-1 img">
							<div class="service__img <?=$animation_type?>">
								<picture>
									...
									<img src="/images/content/services/consultoria.webp" alt="Consultoría | <?=$brand_name?>">
								</picture>
							</div>
						</div>
					</div>
		...
		<?php include("$abs_path/includes/$lang/servicios.php"); ?>

		<?php include("$abs_path/includes/$lang/portafolio.php"); ?>


		<section class="callout callout01">
			<div class="container--wide">
				<h2 class="quote">
					<svg><use xlink:href="#svg-icon-quote-open"></use></svg>
					Te acompañamos en tu proceso de innovación
					<svg><use xlink:href="#svg-icon-quote-close"></use></svg>
				</h2>
			</div>
		</section>
		<section class="home__how">
			<div class="container">
				<h2 class="animation-scroll-text <?=$animation_type?>" data-init-animation="transform:translateX(-50px);opacity:0" data-end-animation="transform:translateX(0px);opacity:1">¿Cómo lo hacemos?</h2>
				<div class="how--wrapper">
					<div class="how__item--wrapper <?=$animation_type?>" data-init-animation="transform:translate(-250px, 250px);opacity:0" data-end-animation="transform:translate(0px, 0px);opacity:1">
						<div class="how__item">
							<svg class="how__icon" alt="Asesoría | <?=$brand_name?>"><use xlink:href="#svg-icon-asesoria"></use></svg>
							<h3 class="how__title">Asesoría</h3>
							<p>Te escuchamos y asesoramos para brindarte la solución más adecuada.</p>
						</div>
					</div>
					<div class="how__item--wrapper <?=$animation_type?>" data-init-animation="transform:translate(0px, 250px);opacity:0" data-end-animation="transform:translate(0px, 0px);opacity:1">
						<div class="how__item active">
							<svg class="how__icon" alt="Empresa en línea | <?=$brand_name?>"><use xlink:href="#svg-icon-online"></use></svg>
					...
					<div class="how__item--wrapper <?=$animation_type?>" data-init-animation="transform:translate(250px, 250px);opacity:0" data-end-animation="transform:translate(0px, 0px);opacity:1">
						<div class="how__item">
							<svg class="how__icon" alt="SEO | <?=$brand_name?>"><use xlink:href="#svg-icon-seo"></use></svg>
							<h3 class="how__title">Te posicionamos<br>en buscadores</h3>
		...
		<section class="home__about">
			...
			<div class="container">
				<h2 class="animation-scroll-text <?=$animation_type?>" data-init-animation="transform:translateX(-50px);opacity:0" data-end-animation="transform:translateX(0px);opacity:1">¿Quiénes somos?</h2>
				...
				<p class="animation-scroll-text <?=$animation_type?>" data-init-animation="transform:translateY(50px);opacity:0" data-end-animation="transform:translateY(0px);opacity:1">
					Bombilla Digital es una agencia creativa formada por un equipo de profesionales con más de 8 años de experiencia, ayudamos a nuestros clientes a ser relevantes en el mundo digital y a tener presencia online para lograr sus objetivos comerciales.
				</p>
				<p class="animation-scroll-text <?=$animation_type?>" data-init-animation="transform:translateY(50px);opacity:0" data-end-animation="transform:translateY(0px);opacity:1">
					Nuestra metodología brinda la certeza de implementar proyectos con éxito.
				</p>
				<p class="animation-scroll-text <?=$animation_type?>" data-init-animation="transform:translateY(50px);opacity:0" data-end-animation="transform:translateY(0px);opacity:1">
					Nos apasiona desarrollar ideas disruptivas e innovadoras, contribuyendo a posicionar a México como líder tecnológico.
				</p>
			</div>
		</section>
		<section class="home__plans">
			...
			<div class="container">
				<h2 class="animation-scroll-text <?=$animation_type?>" data-init-animation="transform:translateY(50px);opacity:0" data-end-animation="transform:translateY(0px);opacity:1">Nuestros<br>planes estratégicos</h2>
				<div class="plan--wrapper">
					<div class="plan__item--wrapper <?=$animation_type?>" data-init-animation="transform:translate(-250px, 250px);opacity:0" data-end-animation="transform:translate(0px, 0px);opacity:1">
							<div class="plan__item">
							<h3 class="plan__title">Página de aterrizaje</h3>
							<ul class="plan__list">
								<li class="plan__list-item"><svg><use xlink:href="#svg-icon-tick"></use></svg>Dominio anual .com o .mx</li>
								<li class="plan__list-item"><svg><use xlink:href="#svg-icon-tick"></use></svg>Hospedaje anual.</li>
								<li class="plan__list-item"><svg><use xlink:href="#svg-icon-tick"></use></svg>Certificado de seguridad.</li>
								<li class="plan__list-item"><svg><use xlink:href="#svg-icon-tick"></use></svg>3 cuentas de correo electrónico.</li>
								<li class="plan__list-item"><svg><use xlink:href="#svg-icon-tick"></use></svg>Diseño y producción de una sola sección informativa.</li>
								<li class="plan__list-item"><svg><use xlink:href="#svg-icon-tick"></use></svg>Formulario de contacto.</li>
								<li class="plan__list-item"><svg><use xlink:href="#svg-icon-tick"></use></svg>Sitio web móvil (responsivo o adaptable).</li>
								<li class="plan__list-item"><svg><use xlink:href="#svg-icon-tick"></use></svg>Burbuja de chat whastApp business.</li>
							</ul>
							<div class="plan__samples">
								<p><svg><use xlink:href="#svg-icon-star"></use></svg>Ejemplo de algunos proyectos</p>
							...
							<div class="plan__cta">
								<a href="<?=$wp['link']?>" class="btn-flat secondary" target="_blank">Hablar con un asesor</a>
							</div>
						</div>
					</div>
					<div class="plan__item--wrapper <?=$animation_type?>" data-init-animation="transform:translate(0px, 250px);opacity:0" data-end-animation="transform:translate(0px, 0px);opacity:1">
							<div class="plan__item">
							<h3 class="plan__title c-primary">Página corporativa</h3>
							<ul class="plan__list">
								<li class="plan__list-item"><svg><use xlink:href="#svg-icon-tick"></use></svg>Dominio anual .com o .com.mx</li>
								<li class="plan__list-item"><svg><use xlink:href="#svg-icon-tick"></use></svg>Hospedaje anual.</li>
								<li class="plan__list-item"><svg><use xlink:href="#svg-icon-tick"></use></svg>Certificado de seguridad.</li>
								<li class="plan__list-item"><svg><use xlink:href="#svg-icon-tick"></use></svg>15 cuentas de correo electrónico empresarial.</li>
								<li class="plan__list-item"><svg><use xlink:href="#svg-icon-tick"></use></svg>Diseño y producción de hasta 5 secciones.</li>
								<li class="plan__list-item"><svg><use xlink:href="#svg-icon-tick"></use></svg>Formulario de contacto.</li>
								<li class="plan__list-item"><svg><use xlink:href="#svg-icon-tick"></use></svg>Sitio web responsivo.</li>
								<li class="plan__list-item"><svg><use xlink:href="#svg-icon-tick"></use></svg>Burbuja de chat WhatsApp Business.</li>
								<li class="plan__list-item"><svg><use xlink:href="#svg-icon-tick"></use></svg>Chat en línea.</li>
								<li class="plan__list-item"><svg><use xlink:href="#svg-icon-tick"></use></svg>Geolocalización.</li>
							</ul>
							<div class="plan__samples">
								<p><svg><use xlink:href="#svg-icon-star"></use></svg>Ejemplo de algunos proyectos</p>
								<ul class="plan__sample-list">
							...
							<div class="plan__cta">
								<a href="<?=$wp['link']?>" class="btn-flat primary" target="_blank">Hablar con un asesor</a>
							</div>
						</div>
					</div>
					<div class="plan__item--wrapper <?=$animation_type?>" data-init-animation="transform:translate(250px, 250px);opacity:0" data-end-animation="transform:translate(0px, 0px);opacity:1">
							...
							<ul class="plan__list">
								...
								<li class="plan__list-item"><svg><use xlink:href="#svg-icon-tick"></use></svg>Diseño y producción de hasta 5 secciones.</li>
								<li class="plan__list-item"><svg><use xlink:href="#svg-icon-tick"></use></svg>Certificado de seguridad.</li>
								<li class="plan__list-item"><svg><use xlink:href="#svg-icon-tick"></use></svg>Catalogo autoadministrable.</li>
								<li class="plan__list-item"><svg><use xlink:href="#svg-icon-tick"></use></svg>Formulario de contacto.</li>
								<li class="plan__list-item"><svg><use xlink:href="#svg-icon-tick"></use></svg>Sitio web responsivo.</li>
								<li class="plan__list-item"><svg><use xlink:href="#svg-icon-tick"></use></svg>Burbuja de chat Whatsapp Business.</li>
								<li class="plan__list-item"><svg><use xlink:href="#svg-icon-tick"></use></svg>Chat en línea.</li>
		...
		<section class="home__comments">
			<div class="container">
				<h2 class="animation-scroll-text <?=$animation_type?>" data-init-animation="transform:translateY(50px);opacity:0" data-end-animation="transform:translateY(0px);opacity:1">Nuestros<br>clientes opinan</h2>
				<div class="comments__slider--wrapper">
					<div id="comments__slider" class="comments__slider">
						<div class="comment__item">
							...
							<div class="comment__text">Profesionalismo, calidad y creatividad son las palabras con las que defino Bombilla Digital. Gracias totales por la creación de centroencalma.com nos encanto y los recomendamos totalmente.</div>
						...
						<div class="comment__item">
							<img class="comment__icon" src="/images/assets/icon-comment.svg" alt="Comentario">
							<div class="comment__text">Profesionalismo, excelente diseño y entrega en tiempo. Entendieron lo que quería</div>
							<div class="comment__author">
						...
						<div class="comment__item">
							<img class="comment__icon" src="/images/assets/icon-comment.svg" alt="Comentario">
							<div class="comment__text">Infinitas Gracias Equipo Bombilla Digital, gracias por escuchar, por Leerme y por conectar, Gracias por todo lo que me han dado y he recibido de su labor congruente en tiempo, forma, estilo.</div>
							<div class="comment__author">
						...
						<div class="comment__item">
							<img class="comment__icon" src="/images/assets/icon-comment.svg" alt="Comentario">
							<div class="comment__text">Considerando que uso sus servicios desde hace varios años los felicito por su nuevo sitio web y por el excelente servicio que brindan! ¡Muy recomendables!</div>
							<div class="comment__author">
		...
		<section class="callout callout02">
			<div class="container">
				<p>
					Te ayudamos a crear una imagen profesional que te ayude a direfenciarte y te posicionamos en el mundo online
				</p>
