        ...
        <div class="box-container">
            <div class="info-project">
                <div class="box-child info-img">
                    <picture>
                        <source srcset="./images/content/project/silver/lap.webp" type="image/webp">
                        <source srcset="./images/content/project/silver/lap.png" type="image/png">
                        <img src="./images/content/project/silver/lap.webp" alt="jytech" loading="lazy">
                    </picture>
                </div>
                <div class="box-child info-text">
                    <p class="title">Desarrollo Web</p>
                    <img src="./images/content/project/line.svg" alt="line" loading="lazy">
                    <a href="https://www.silver.com.mx">
                        <img src="./images/content/portafolio/icon-url.svg" alt="Icon url">
                        www.silver.com.mx
                    </a>
                    <h2>Sergios's silver<br>from taxco</h2>
            ...
            <div class="box-devices">
                <picture>
                    <source srcset="./images/content/project/silver/mov.webp" type="image/webp">
                    <source srcset="./images/content/project/silver/mov.png" type="image/png">
                    <img class="mov" src="./images/content/project/silver/mov.webp" alt="jytech" loading="lazy">
                </picture>
                <picture>
                    <source srcset="./images/content/project/silver/device.webp" type="image/webp">
                    <source srcset="./images/content/project/silver/device.png" type="image/png">
                    <img class="device" src="./images/content/project/silver/device.webp" alt="jytech" loading="lazy">
                </picture>
            </div>
        </div>
    </section>
