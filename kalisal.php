        ...
        <div class="box-container">
            <div class="info-project">
                <div class="box-child info-img">
                    <picture>
                        <source srcset="./images/content/project/kalisal/lap.webp" type="image/webp">
                        <source srcset="./images/content/project/kalisal/lap.png" type="image/png">
                        <img src="./images/content/project/kalisal/lap.webp" alt="jytech" loading="lazy">
                    </picture>
                </div>
                <div class="box-child info-text">
                    <p class="title">Desarrollo Web</p>
                    <img src="./images/content/project/line.svg" alt="line" loading="lazy">
                    <a href="https://www.kalisal.com">
            ...
            <div class="box-devices">
                <picture>
                    <source srcset="./images/content/project/kalisal/mov.webp" type="image/webp">
                    <source srcset="./images/content/project/kalisal/mov.png" type="image/png">
                    <img class="mov" src="./images/content/project/kalisal/mov.webp" alt="jytech" loading="lazy">
                </picture>
                <picture>
                    <source srcset="./images/content/project/kalisal/device.webp" type="image/webp">
                    <source srcset="./images/content/project/kalisal/device.png" type="image/png">
                    <img class="device" src="./images/content/project/kalisal/device.webp" alt="jytech" loading="lazy">
                </picture>
            </div>
        </div>
    </section>
